...
const page = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        <Title title={'My Bookings'} subTitle='Easily manage your past,current, and upcomi
             manage your past,current, and upcomi  manage your past,current, and upcomi' align='left'/>
    
       <div className='max-w-6xl mt-8 w-full text-gray-800'>
           <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] border-b
            ...
            bookings.map((booking)=>(
                ...
                w-full border-b border-gray-300 py-6 first:border-t'>
                    ...
                    <div className='flex flex-col md:flex-row'>
                      <Image src={booking.room.images[0]} alt='hotel-img'
                      ...
                      <div className='flex flex-col gap-1.5 max-md:mt-3 md:ml-4'>
                        ...
                        <div className='flex items-center gap-1 text-sm text-gray-500'>
                          <Image src={assets.locationIcon} alt='locaion-icon'/>
