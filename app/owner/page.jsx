...
export default function OwnerDashboard() {
  ...
  return (
    <div>
         ...
         room listings room listings room listings room listings room listings 
         room listings' />

         <div className="flex gap-4 my-8">
              {/* ----------Total Bookings------------- */}
              <div className="bg-purple-700/3 border border-amber-50/10 rounded flex px-4
              pr-8">
                   ...
                   <table className="w-full">
                     <thead className="bg-gray-50">
                        <tr>
                            ...
                            text-center">Total Revenue</th>
                            <th className="py-3 px-4 text-gray-800 font-medium text-center">Payment Statement</th>
                        </tr>
                     </thead>
