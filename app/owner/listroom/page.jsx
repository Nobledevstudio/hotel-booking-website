...
const page = () => {
  ...
  return (
    <div>
      <Title align='left' font='Outfit' title='Room Listings' subTitle='View, Edits or all listed rooms View, Edits or all listed rooms
      View, Edits or all listed rooms View, Edits or all listed rooms'/>
