...
const page = () => {
  ...
  return (
      <form>
           <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the Details Fill in the Details
           Fill in the DetailsFill in the DetailsFill in the Details'/>
           ...
           <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                ...
                <div>
                    <p className='mt-4 text-gray-800'>
                      ...
                      <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounde p-2 w-24'
           ...
           <button className='bg-blue-500 text-center px-8 py-2 rounded mt-8
           cursor-pointer'>
                Add Room
           </button>
      </form>
