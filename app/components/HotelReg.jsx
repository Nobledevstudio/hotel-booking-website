  ...
  return (
    ...
    bg-black/70'>
       <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
         <Image src={assets.regImage} alt='reg-image' className='w-1/2 rounded-xl
         hidden md:block'/>

         <div className='relative flex flex-col items-center md:w-1/2 p-8 mb:p-10'>
            <Image src={assets.closeIcon} alt='close-Icon' className='absolute top-4
